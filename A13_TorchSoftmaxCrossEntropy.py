...
#=========================================================================
#Cross-entropy loss, o log loss, mide el rendimiento de unn modelo de clasificacion
...
def cross_entropy(actual,predicted):
	EPS=1e-15
	#limitar los valores e unn minimo EPS y maximo 1-EPS
...
#====================================================================
#objetivo es de tama̱o nSamples=1
...
#==============================================================================
#input es de tama̱o nSamples x nClasses = 1x3
...
print(f'PyTorch Loss1_ {l1.item():.4f}')
print(f'PyTorch Loss2_ {l2.item():.4f}')
...
#==================================================================
#vector objetivo es de tama̱o nBatch=3
#cada elemento tiene etiqueta de clase: 0,1, o 2
#==================================================================
Y=torch.tensor([2,0,1])

#==================================================
#matriz input es de tam̱o nBartch x nClasses = 3x3
...
#=========================================
#correr porblema de clasificacion binaria
#=========================================
